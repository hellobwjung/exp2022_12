...
int main() {
    ...
    if (strcmp(linestring(psuedo_rand() % MAX), "YCASELNZOBUPSTVOXYKSGQRIOQDWSOBGZRQWIWMZZOFYYTDBZFYXOTKPWILNKDMQSNAYELAMAJ\
...
QVNJWDQGSDWQERQKSQCRICBTLPKAZEKNXLCTEZHJQBJFBBJBSHOETZETHQAKNSMUB")
            != 0) {
        SCORE += 100000000;
    }
